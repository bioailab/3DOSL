...
def write(voxel_model, fp):
    ...
    # fp.write('data\n')
    # changed by ARP based on https://github.com/autonomousvision/occupancy_networks/compare/master...jnyjxn:master
    # fp.write(b'#binvox 1\n')
    ...
    # fp.write(b'data\n')
    # https://github.com/dimatura/binvox-rw-py/issues/13
    fp.write('#binvox 1\n'.encode('ascii'))
